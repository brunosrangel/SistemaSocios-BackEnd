...
namespace SistemaSocios.WebApi.MySql.Controllers
{
    ...
    public class StatusMensalidadeController : BaseController<StatusMensalidadeModel, IGenericService<StatusMensalidadeModel>>
    {
        ...
        public StatusMensalidadeController(ITokenService tokenService, ILogger<StatusMensalidadeModel> loger, IGenericService<StatusMensalidadeModel> genericService) : base(genericService, loger)
        {
