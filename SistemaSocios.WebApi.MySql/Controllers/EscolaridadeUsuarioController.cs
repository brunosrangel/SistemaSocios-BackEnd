...
namespace SistemaSocios.WebApi.MySql.Controllers
{
    ...
    public class EscolaridadeUsuarioController : BaseController<EscolaridadeUsuarioModel, IGenericService<EscolaridadeUsuarioModel>>
    {
        ...
        public EscolaridadeUsuarioController(ITokenService tokenService, ILogger<EscolaridadeUsuarioModel> loger, IGenericService<EscolaridadeUsuarioModel> genericService) : base(genericService, loger)
        {
