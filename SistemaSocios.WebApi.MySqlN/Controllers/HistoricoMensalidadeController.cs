...
namespace SistemaSocios.WebApi.MySql.Controllers
{
    public class HistoricoMensalidadeController : BaseController<HistoricoMensalidadesModel, IGenericService<HistoricoMensalidadesModel>>
    {
        ...
        public HistoricoMensalidadeController(ITokenService tokenService, ILogger<HistoricoMensalidadesModel> loger, IGenericService<HistoricoMensalidadesModel> genericService) : base(genericService, loger, tokenService)
        {
