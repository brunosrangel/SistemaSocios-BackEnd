...
namespace SistemaSocios.WebApi.MySql.Controllers
{
    public class EntidadeController : BaseController<EntidadeModel, IGenericService<EntidadeModel>>
    {
        ...
        public EntidadeController(ITokenService tokenService, ILogger<EntidadeModel> loger, IGenericService<EntidadeModel> genericService) : base(genericService, loger, tokenService)
        {
