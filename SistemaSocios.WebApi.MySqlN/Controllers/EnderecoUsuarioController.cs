...
namespace SistemaSocios.WebApi.MySql.Controllers
{
    public class EnderecoUsuarioController : BaseController<EnderecoUsuarioModel, IGenericService<EnderecoUsuarioModel>>
    {
        ...
        public EnderecoUsuarioController(ITokenService tokenService, ILogger<EnderecoUsuarioModel> loger, IGenericService<EnderecoUsuarioModel> genericService) : base(genericService, loger, tokenService)
        {
